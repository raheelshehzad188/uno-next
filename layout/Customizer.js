...
const Customizer = () => {
  ...
  const notify = () =>
    toast(`config copied successfully`, {
      type: "success",
      position: "top-right",
    });
  const handleCopy = () =>
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      setConfig((prev) => ({
        ...prev,
        LayoutMode: document.body.classList.contains("dark-layout")
          ? "dark-layout"
          : "light-layout",
      }));
    }, 100);
            ...
            <ul>
              ...
              <li>
                <span className="text-danger">
                  * (You need to put this in config/themeCustomizerConfig.js to
                  reflect your changes permently){" "}
                </span>
              </li>
            </ul>
            <Button
