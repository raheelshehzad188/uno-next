      ...
      <div className="single-property-section">
        <div className="single-title h-100">
          <div className="left-single w-100">
            <span class="font-roboto">{value?.city_name}</span>
            ...
            {/* <h6 className="mb-3 glassy">
                ...
                }).format(value?.community_starting_price * currencyValue)}{" "}
...
export default CommunityTopTitle;
